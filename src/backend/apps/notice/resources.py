...
class GetMsgType(NoticeMeta, Resource):
...
class ListNoticeGroup(NoticeMeta, Resource):
    ...
    def perform_request(self, validated_request_data):
        ...
        # 响应
        bk_audit_client.add_event(action=ActionEnum.LIST_NOTICE_GROUP, resource_type=ResourceEnum.NOTICE_GROUP)
        return notice_groups


class ListAllNoticeGroup(NoticeMeta, Resource):
...
class RetrieveNoticeGroup(NoticeMeta, Resource):
    ...
    def perform_request(self, validated_request_data):
        ...
        bk_audit_client.add_event(
            action=ActionEnum.LIST_NOTICE_GROUP,
            resource_type=ResourceEnum.NOTICE_GROUP,
            instance=notice_group.audit_instance,
        )
        return notice_group


class CreateNoticeGroup(NoticeMeta, Resource):
    ...
    def perform_request(self, validated_request_data):
        ...
        # 响应
        bk_audit_client.add_event(
            action=ActionEnum.CREATE_NOTICE_GROUP,
            resource_type=ResourceEnum.NOTICE_GROUP,
            instance=notice_group.audit_instance,
        )
        return notice_group
...
class UpdateNoticeGroup(NoticeMeta, Resource):
    ...
    def perform_request(self, validated_request_data):
        ...
        bk_audit_client.add_event(
            action=ActionEnum.EDIT_NOTICE_GROUP_V2,
            resource_type=ResourceEnum.NOTICE_GROUP,
            instance=notice_group.audit_instance,
        )
        return notice_group
...
class DeleteNoticeGroup(NoticeMeta, Resource):
    ...
    def perform_request(self, validated_request_data):
        ...
        # 删除
        bk_audit_client.add_event(
            action=ActionEnum.DELETE_NOTICE_GROUP_V2,
            resource_type=ResourceEnum.NOTICE_GROUP,
            instance=notice_group.audit_instance,
        )
        notice_group.delete()
