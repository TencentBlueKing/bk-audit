...
try:
    ...
    ManualRiskEventResourceProvider = None
...
if ManualRiskEventResourceProvider is not None:
    resources_dispatcher.register(ResourceEnum.MANUAL_RISK_EVENT.id, ManualRiskEventResourceProvider())
