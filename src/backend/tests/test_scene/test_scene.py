...
class TestSceneResource(TestCase):
    ...
    def test_scene_retrieve_risk_count_uses_default_recent_window(self):
        ...
        for display_status in active_display_statuses:
            Risk.objects.create(
                raw_event_id=f"raw-scene-detail-active-{display_status}",
                strategy=strategy,
        ...
        self.assertEqual(result["risk_count"], len(active_display_statuses))
    ...
    def test_get_scene_info_risk_count_uses_default_recent_window(self):
        ...
        for display_status in active_display_statuses:
            Risk.objects.create(
                raw_event_id=f"raw-scene-info-active-{display_status}",
                strategy=strategy,
                display_status=display_status,
                event_time=timezone.now(),
                event_end_time=timezone.now(),
