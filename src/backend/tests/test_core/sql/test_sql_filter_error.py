...
from core.sql.sql_builder import SQLGenerator, QueryBuilder
from core.sql.constants import FieldType, Operator, AggregateType
class FilterValueErrorTests(TestCase):
    ...
    def test_normal_field_invalid_int_conversion(self):
        ...
        self.assertEqual(
            str(cm.exception),
            "条件表达式中字段 age 的值  abc 无法转换成预期类型 <class 'int'>。"
        )
    ...
    def test_aggregate_field_count_conversion_failure(self):
        ...
        self.assertEqual(
            str(cm.exception),
            "条件表达式中字段 user_count 的值 COUNT (xyz) 无法转换成预期类型 <class 'int'>。"
        )
    ...
    def test_aggregate_field_sum_conversion_failure(self):
        ...
        self.assertEqual(
            str(cm.exception),
            "条件表达式中字段 total_amount 的值 SUM (invalid_number) 无法转换成预期类型 <class 'float'>。"
        )
    ...
    def test_list_field_invalid_int_conversion(self):
        ...
        self.assertEqual(
            str(cm.exception),
            "条件表达式中字段 age 的值  ['1a', 'b2'] 无法转换成预期类型 <class 'int'>。"
        )
    ...
    def test_list_field_invalid_timestamp_conversion(self):
        ...
        self.assertEqual(
            str(cm.exception),
            "条件表达式中字段 create_time 的值  ['2023-13-32', 'invalid-date'] 无法转换成预期类型 <class 'int'>。"
        )