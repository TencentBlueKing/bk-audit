...
# AI 助手会话标题生成（共用智能体 ALS_TITLE_SUM，与风险报告标题同一智能体；
# 统一 User Prompt 模板与模块配置见 services/web/ai_assistant/constants.py）
AI_TITLE_USER_PROMPT_TEMPLATE = os.getenv("BKAPP_AI_TITLE_USER_PROMPT_TEMPLATE", "")
AI_CONVERSATION_TITLE_MAX_LENGTH = int(os.getenv("BKAPP_AI_CONVERSATION_TITLE_MAX_LENGTH", "20"))
