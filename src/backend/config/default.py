...
# 处理日志导出任务定时任务调度周期(分)
PROCESS_LOG_EXPORT_TASK_MINUTE = os.getenv("BKAPP_PROCESS_LOG_EXPORT_TASK_MINUTE", "*/10")

# 处理日志导出任务缓存锁超时时间(秒)
PROCESS_LOG_EXPORT_TASK_CACHE_LOCK_TIMEOUT = int(
    os.getenv("BKAPP_PROCESS_LOG_EXPORT_TASK_CACHE_LOCK_TIMEOUT", 60 * 60 * 24)
)
...
# 日志导出最大条数
LOG_EXPORT_MAX_COUNT = int(os.getenv("BKAPP_LOG_EXPORT_MAX_COUNT", 1000000))
