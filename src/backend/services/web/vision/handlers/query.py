        ...
        for panel in vision_data["data"]["panels"]:
            ...
            match chart_config.get("flag"):
                case self.action_key_variable:
                    modify_panel_meta(self.filter_handler_class(), chart_config, vision_data, uid)
        return vision_data
    ...
    def query_dataset(self, params: dict) -> dict:
        ...
        for variable_config in variables:
            match variable_config["flag"]:
                case self.action_key_variable:
                    variable_config["value"] = self.filter_handler_class().check_data(variable_config["value"])
