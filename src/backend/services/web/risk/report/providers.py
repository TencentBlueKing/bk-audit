...
class AIProvider(Provider):
    ...
    def __init__(self, context: dict[str, Any], ai_variables_config: list[dict] = None,
                 ai_executor: Callable = None, key: str = "ai"):
        """初始化AI Provider
        ...
        self.ai_variables_config = {
            var["name"]: var for var in (ai_variables_config or [])
        }
