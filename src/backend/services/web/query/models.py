...
class ExportFieldLog(OperateRecordModel):
    ...
    keys = MultiStrSplitCharField(gettext_lazy("字段键"), max_length=1024, default="", blank=True, db_index=True)
    display_name = models.CharField(gettext_lazy("展示名称"), max_length=255)
