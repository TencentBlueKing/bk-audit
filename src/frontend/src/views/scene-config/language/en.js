...
export default {
  platformManage: {
    ...
    '确定删除该报告？': 'Confirm to delete this report?',
    删除的报告将: 'The deleted report will be ',
    无法找回: 'unrecoverable',
    '，请谨慎操作！': ', please proceed with caution!',
    请输入报表名称: 'Please enter the report name ',
    以确认删除: ' to confirm deletion',
    请输入待删除的报表名称: 'Please enter the report name to delete',
    ...
    '确认启用该报表？': 'Confirm to enable this report?',
    '确认停用该报表？': 'Confirm to disable this report?',
    '启用后，该报表将在审计报表菜单中展示': 'After enabling, this report will be displayed in the audit report menu',
    '停用后，该报表将从审计报表菜单中隐藏': 'After disabling, this report will be hidden from the audit report menu',
    // Create/Edit Report Sideslider
    编辑报表: 'Edit Report',
    '关联 BKVision 报表': 'Link BKVision Report',
    请选择: 'Please select',
    预览: 'Preview',
    '请输入报表名称（选择报表后自动填充）': 'Please enter report name (auto-filled after selecting report)',
    所属分组: 'Group',
    是否启用: 'Enable',
    停用后将在审计报表菜单中隐藏: 'After disabling, it will be hidden from the audit report menu',
    ...
    场景信息: 'Scene Info',
    关联系统: 'Linked Systems',
    关联数据表: 'Linked Data Tables',
    审计策略: 'Audit Strategies',
    活跃风险: 'Active Risks',
    查看详情: 'View Details',
    基础信息: 'Basic Info',
    场景ID: 'Scene ID',
    ...
    '由蓝鲸审计中心管理员配置，场景管理员仅可查看，如需调整请联系 审计中心平台管理员: ': 'Configured by BlueKing Audit Center admin, scene managers can only view. Please contact the Audit Center platform admin for adjustments: ',
    '由蓝鲸审计中心管理员配置，场景管理员仅可查看，可基于数据报表配置审计策略，在工具广场创建 SQL 工具，如需调整请联系 审计中心平台管理员: ': 'Configured by BlueKing Audit Center admin, scene managers can only view. You can configure audit strategies based on data tables and create SQL tools in the Tool Square. Please contact the Audit Center platform admin for adjustments: ',
    关联数据报表: 'Linked Data Tables',
    系统名称: 'System Name',
    系统管理员: 'System Admin',
    系统域名: 'System Domain',
    数据范围: 'Data Scope',
    可用字段: 'Available Fields',
    '近 7 天数据量': 'Data Volume (7 Days)',
    最近数据时间: 'Latest Data Time',
    最新数据样本: 'Latest Data Sample',
    数据报表名称: 'Data Table Name',
    管理员: 'Admin',
  },
  landing: {
    了解场景配置: 'Learn About Scene Configuration',
    ...
    申请创建审计场景: 'to apply for creating an audit scenario',
    IEG安全助手: '(IEG Security Assistant)',
  },
  userLanding: {
    ...
    '查看 TSM 审批': 'View TSM approval',
    申请: 'Apply',
    '需要创建新的业务场景？': 'Need to create a new business scenario?',
  },
};
