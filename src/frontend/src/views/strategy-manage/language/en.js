...
export default {
  strategyManage: {
    ...
    管理员: 'Administrator',
    描述: 'Description',
    '当前系统为从“权限中心”接入，在审计中心所做的变更将会完全同步至审计中心，请确认后操作': 'The current system is accessed from the "Authority Center", and the changes made in the audit Center will be completely synchronized to the audit center. Please confirm and operate',
